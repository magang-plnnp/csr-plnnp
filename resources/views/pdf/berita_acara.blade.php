...
<head>
    ...
    <style>
        ...
        header {
            position: fixed;
            top: 1.27cm; /* jarak dari tepi atas */
            left: 2.5cm;
            right: 2.54cm;
            text-align: center;
        }
        ...
        footer {
            position: fixed;
            bottom: 1.27cm; /* jarak dari tepi bawah */
            left: 2.5cm;
            right: 2.54cm;
            text-align: center;
        }
        ...
        .label {
            ...
            min-width: 80px; /* Sesuaikan agar sejajar */
        }
        ...
        .content {
            margin-top: 0; /* biar nggak ada margin dobel */
        }
        .tight-bottom {
            margin-bottom: 0;
            padding-bottom: 0;
            line-height: 1; /* pastikan tidak ada space ekstra */
        }
        ...
        .section p.indent {
            margin: 0; /* pastikan baris nama/jabatan juga rapat */
            line-height: 1.2;
        }
        .spasi-atas {
            margin-top: 10px; /* bisa 8px, 10px, atau sesuai kebutuhan */
        }
...
<body>
    ...
    <p class="tight-bottom">Pada hari ini {{ \App\Helpers\DateHelper::tanggalTerbilang() }}, yang bertanda tangan dibawah ini:
    </p>
    ...
    <div class="section tight-top">
        ...
        <p>Dalam hal ini bertindak sebagai Manajer Business Support 
            ...
            yang selanjutnya disebut <strong>PIHAK PERTAMA</strong>.</p>

        <p class="spasi-atas indent"><span class="label">Nama</span><span class="separator">:</span><span class="value">{{ $data->nama_penerima }}</span></p>
        <p class="indent"><span class="label">Jabatan</span><span class="separator">:</span><span class="value">{{ $data->jabatan_penerima }}</span></p>

        <p>Dalam hal ini bertindak untuk dan atas nama
            <strong>{{ $data->jabatan_penerima }}</strong>,
            selanjutnya disebut <strong>PIHAK KEDUA</strong>.</p>
    </div>
   ...
   <table class="tabel-bantuan" border="1" cellspacing="0" cellpadding="5" style="width:100%; border-collapse: collapse;">
    ...
    <div class="section">
        <p>
            <strong>PIHAK PERTAMA</strong> menyerahkan bantuan kepada <strong>PIHAK KEDUA</strong> dengan mengedepankan azas Kepatuhan Terhadap Hukum dan
        ...
        <p>(5). Apabila salah satu <strong>PIHAK</strong> terbukti melanggar ketentuan sebagaimana dimaksud dalam Pasal ini, maka
            ...
            <ol class="csr-list-custom">
                <li><strong>PARA PIHAK</strong> menyepakati bahwa pada saat melaksanakan program Corporate Social Responsibility ini
                    berdasarkan pada prinsip itikad baik, tidak saling mempengaruhi baik langsung maupun tidak langsung guna
                    memenuhi keinginannya, menerima serta bertanggungjawab atas segala keputusan yang ditetapkan sesuai dengan
                    kesepakatan <strong>PARA PIHAK</strong>, menghindari serta mencegah terjadinya pertentangan kepentingan (conflict of
                    interest), menghindari serta mencegah penyalahgunaan wewenang dan/atau kolusi dan/atau korupsi dengan tujuan
                ...
                <li><strong>PARA PIHAK</strong> menyepakati bahwa dalam pelaksanaan program Corporate Social Responsibility ini selalu
                    mengambil tindakan yang cukup untuk memastikan <strong>PARA PIHAK</strong> patuh terhadap setiap hukum Indonesia yang
                    berlaku, tidak terbatas pada Undang-Undang Nomor 31 Tahun 1999 Juncto Undang-Undang Nomor 20 Tahun 2001
                    tentang Pemberantasan Tindak Pidana Korupsi serta bersedia dikenakan sanksi berdasarkan ketentuan peraturan
                    perundang-undangan apabila terbukti terlibat Korupsi, Kolusi, Nepotisme (KKN), penyuapan dan lain
                ...
                <li><strong>PIHAK KESATU</strong> dengan ini menjamin dalam pelaksanaan program Corporate Social Responsibility ini tidak
                    menyalahgunakan uang dan/atau dana bantuan selain untuk tujuan sebagaimana diatur dalam Kesepakatan
                    Kerjasama ini, tidak di bawah pengaruh kepentingan <strong>PIHAK KEDUA</strong> atau <strong>pihak lainnya</strong> dalam mengambil tindakan
                ...
                <li><strong>PIHAK KEDUA</strong> selaku penerima bantuan program Corporate Social Responsibility menjamin tidak akan
                    menawarkan, menjanjikan, memberikan kontribusi, melakukan penyuapan, dan/atau memberikan manfaat lain kepada
                    pegawai <strong>PIHAK KESATU</strong>, serta tidak menyalahgunakan dana bantuan program Corporate Social Responsibility
                    tersebut selain untuk tujuan dalam Kesepakatan Kerja Sama ini.
                </li>
                <li>Apabila salah satu <strong>PIHAK</strong> terbukti melanggar ketentuan sebagaimana dimaksud dalam Pasal ini, maka
