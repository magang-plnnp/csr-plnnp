<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
            <a class="sidebar-link  {{ Request::is('proposal*') ? 'active' : '' }}" href="/proposal"
                aria-expanded="false">
                <span>
...
<div id="customLogoutModal"
    style="display:none; position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: 1050;">
    <div
        style="max-width: 500px; margin: 2% auto 0 auto; background-color: #fff; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.2);">
        <div
