                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3 text-end">
                        <button style="background-color: #78C841; color: white;" class="btn" data-bs-toggle="modal"
                            data-bs-target="#createTipeModal">
                            <i class="fas fa-plus me-1"></i> Tambah Tipe Proses
                        </button>
                    </div>
                    ...
                    @foreach ($tipeProses as $proses)
                        <div class="mb-4">
                            ...
                            <div class="text-end mt-2">
                                <button style="background-color: #78C841; color: white;" type="button"
                                    class="btn btn-sm btn-add-sub" data-tipe="{{ $proses->id }}" data-bs-toggle="modal"
                                    data-bs-target="#createSubModal">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="edit-tipe-nama" name="nama" required
                                autofocus>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="edit-sub-nama" name="nama_sub" required
                                autofocus>
                        </div>
                        <div class="mb-3">
            ...
            document.querySelectorAll(".sortable").forEach(function(el) {
                new Sortable(el, {
                    ...
                    onEnd: function() {
                        ...
                        const ids = Array.from(el.querySelectorAll('tr')).map(tr => tr
